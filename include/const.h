...
#define FLAG_BREAK	    0x000080		            /* Break Code			*/
#define FLAG_EXT	    0x000100		            /* Normal function keys		*/
#define FLAG_SHIFT_L	0x000200		            /* Shift key			*/
#define FLAG_SHIFT_R	0x000400		            /* Shift key			*/
#define FLAG_CTRL_L	    0x000800		            /* Control key			*/
#define FLAG_CTRL_R	    0x001000		            /* Control key			*/
#define FLAG_ALT_L	    0x002000		            /* Alternate key		*/
#define FLAG_ALT_R	    0x004000		            /* Alternate key		*/
#define FLAG_PAD	    0x008000		            /* keys in num pad		*/
#define FLAG_CAPS       0x010000		            /* caps   key		    */
#define FLAG_NUM        0x020000		            /* num    key		    */
#define FLAG_SCROLL     0x040000		            /* scroll key			*/
...
#define MID		        (0x29 + FLAG_EXT)	    /* Right	*/

/* ACPI keys */     
#define POWER		    (0x2A + FLAG_EXT)	    /* Power	*/
#define SLEEP		    (0x2B + FLAG_EXT)	    /* Sleep	*/
#define WAKE		    (0x2C + FLAG_EXT)	    /* Wake Up	*/

/* Num Pad */       
#define PAD_SLASH	    ('/'   + FLAG_PAD)	    /* /		*/
#define PAD_STAR	    ('*'   + FLAG_PAD)	    /* *		*/
#define PAD_MINUS	    ('-'   + FLAG_PAD)	    /* -		*/
#define PAD_PLUS	    ('+'   + FLAG_PAD)	    /* +		*/
#define PAD_ENTER	    (ENTER + FLAG_PAD)	    /* Enter	*/
#define PAD_DOT		    ('.'   + FLAG_PAD)	    /* .		*/
#define PAD_0		    ('0'   + FLAG_PAD)	    /* 0		*/
#define PAD_1		    ('1'   + FLAG_PAD)	    /* 1		*/
#define PAD_2		    ('2'   + FLAG_PAD)	    /* 2		*/
#define PAD_3		    ('3'   + FLAG_PAD)	    /* 3		*/
#define PAD_4		    ('4'   + FLAG_PAD)	    /* 4		*/
#define PAD_5		    ('5'   + FLAG_PAD)	    /* 5		*/
#define PAD_6		    ('6'   + FLAG_PAD)	    /* 6		*/
#define PAD_7		    ('7'   + FLAG_PAD)	    /* 7		*/
#define PAD_8		    ('8'   + FLAG_PAD)	    /* 8		*/
#define PAD_9		    ('9'   + FLAG_PAD)	    /* 9		*/

#define PAD_DEL		    (DELETE   + FLAG_PAD)	/* .		*/
#define PAD_INS		    (INSERT   + FLAG_PAD)	/* 0		*/
#define PAD_END		    (END      + FLAG_PAD)	/* 1		*/
#define PAD_DOWN		(DOWN     + FLAG_PAD)	/* 2		*/
#define PAD_PAGEDOWN    (PAGEDOWN + FLAG_PAD)	/* 3		*/
#define PAD_LEFT		(LEFT     + FLAG_PAD)	/* 4		*/
#define PAD_MID		    (MID      + FLAG_PAD)	/* 5		*/
#define PAD_RIGHT		(RIGHT    + FLAG_PAD)	/* 6		*/
#define PAD_HOME		(HOME     + FLAG_PAD)	/* 7		*/
#define PAD_UP		    (UP       + FLAG_PAD)	/* 8		*/
#define PAD_PAGEUP		(PAGEUP   + FLAG_PAD)	/* 9		*/
